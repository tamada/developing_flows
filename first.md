...
* [リポジトリをGitHubに作成し，各種ファイルを追加する．](#リポジトリをgithubに作成し，各種ファイルを追加する)
...
名前の決め方の指針として，以下のものが挙げられるが，最終的には開発者の好みで付ければ良い．ただし，Googlabilityについては考慮しておこう．また，世界に向けて発信するため，アルファベットの名前をつけたほうが良いだろう．
