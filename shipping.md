...
* [:package: リリースに向けて](shipping.md#readme)
  * [:sunny: バージョンを決める．](shipping.md#バージョンを決める)
  * [:spider_web: Webサイトを構築する．](shipping.md#webサイトを構築する)
  * [:whale: Dockerfileを用意する．](shipping.md#dockerfileを用意する)
  * [:rocket: パッケージマネージャでのインストールを整備する．](shipping.md#パッケージマネージャでのインストールを整備する)
  * [:orange_book: 必要に応じてDOIを発行する．](shipping.md#必要に応じてdoiを発行する)
  * [:sparkles: リリースを公開する．](shipping.md#リリースを公開する)
  * [:balloon: 宣伝しよう．](shipping.md#宣伝しよう)
