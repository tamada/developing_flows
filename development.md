...
なお，サービスのサイト上で，どの部分が未テストかを確認できるが，これはローカル環境でのテストレポートを見て確認しよう．coverallsやcodecovなどに反映させるにはコミットが必要となるが，未テストかを確認するのはコミットの前である方が望ましいためである．

### プログラムの品質を測定する

プログラムの品質測定ツールやサービスを利用して，品質を自動測定しよう．
