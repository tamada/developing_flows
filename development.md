...
* [プログラムを書き始めよう](development.md#readme)
  * [ビルドファイルを用意する．](development.md#ビルドファイルを用意する)
  * [CIを整備する．](development.md#ciを整備する)
  * [テストデータを準備する．](development.md#テストデータを準備する)
  * [プログラムを書き始める．](development.md#プログラムを書き始める)
